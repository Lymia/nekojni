...
impl ClassWriter {
    ...
    pub fn write(mut self, mut write: impl Write) -> Result<(), Error> {
        ...
        // classfile version 49.0 (Java 5)
        //
        // We do this so we don't have to generate a stack map. The code generated by nekojni
        // is actually targeted at Java 8 or later.
        //
        // TODO: This is a temporary hack, and will eventually be improved.
        write.write_u16::<BE>(0)?;
        write.write_u16::<BE>(49)?;
